        ...
        if args.embeds_cache_2d is not None:
            ...
            if args.dataset == 'MiniImageNet':
                if args.backbone_class == 'ConvNet':
                    ...
                    # print('loading ./embeds_cache/embeds_cache_cnn4_feat_trained_evalon_2d.pt')
                    # proto_dict_2d = torch.load('./embeds_cache/embeds_cache_cnn4_feat_trained_evalon_2d.pt')
                    # print('loading ./embeds_cache/embeds_cache_cnn4_2d.pt')
                    # proto_dict_2d = torch.load('./embeds_cache/embeds_cache_cnn4_2d.pt')
                    # print('loading ./embeds_cache/embeds_cache_cnn4_ver1-re-100553_og-1_evalon_2d.pt')
                    # proto_dict_2d = torch.load('./embeds_cache/embeds_cache_cnn4_ver1-re-100553_og-1_evalon_2d.pt')
                    print('loading ./embeds_cache/embeds_cache_cnn4_just_init_evaloff_nodropout_2d.pt')
                    proto_dict_2d = torch.load('./embeds_cache/embeds_cache_cnn4_just_init_evaloff_nodropout_2d.pt')

                    # print('loading ./embeds_cache/embeds_cache_cnn4_feat_trained_evaloff_2d.pt')
                    # proto_dict_2d = torch.load('./embeds_cache/embeds_cache_cnn4_feat_trained_evaloff_2d.pt')
                elif args.backbone_class == 'Res12':
                    # print('loading embeds_cache_r12_contrastive-init-ver2_2d.pt')
                    # proto_dict_2d = torch.load('./embeds_cache/embeds_cache_r12_contrastive-init-ver2_2d.pt')
                    print('loading embeds_cache_res12_2d_just_init.pt')
                    proto_dict_2d = torch.load('./embeds_cache/embeds_cache_res12_2d_just_init.pt')
                    # print('loading embeds_cache_res12_feat_trained_evalon_2d.pt')
                    # proto_dict_2d = torch.load('./embeds_cache/embeds_cache_res12_feat_trained_evalon_2d.pt')
                    # print('loading embeds_cache_res12_ver2-128-111853_og-1_evalon_2d.pt')
                    # proto_dict_2d = torch.load('./embeds_cache/embeds_cache_res12_ver2-128-111853_og-1_evalon_2d.pt')
                    # print('loading ./embeds_cache/embeds_cache_r12_just_init_evaloff_nodropout_2d.pt')
                    # proto_dict_2d = torch.load('./embeds_cache/embeds_cache_r12_just_init_evaloff_nodropout_2d.pt')
                    ...
                    print('loading embeds_cache_wrn_feat_init_evaloff_2d.pt')
                    proto_dict_2d = torch.load('./embeds_cache/embeds_cache_wrn_feat_init_evaloff_2d.pt')
                elif args.backbone_class == 'Res18':
                    print('loading embeds_cache_res18_feat_init_evaloff_2d.pt')
                    proto_dict_2d = torch.load('./embeds_cache/embeds_cache_res18_feat_init_evaloff_2d.pt')
